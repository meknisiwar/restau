...
('admin@example.com','[\"ROLE_ADMIN\"]','$2y$10$Qbata.6u4i9R1Z.tA2vSreZ5DRChegdmuXDO0zMDOuDQHLyNUICmy','Admin','User',NULL,NULL,NOW()),
('alice@example.com','[\"ROLE_USER\"]','$2y$10$Qbata.6u4i9R1Z.tA2vSreZ5DRChegdmuXDO0zMDOuDQHLyNUICmy','Alice','Smith',NULL,NULL,NOW()),
('bob@example.com','[\"ROLE_USER\"]','$2y$10$Qbata.6u4i9R1Z.tA2vSreZ5DRChegdmuXDO0zMDOuDQHLyNUICmy','Bob','Jones',NULL,NULL,NOW());
...
INSERT INTO orders (status, total_amount, delivery_address, phone, notes, created_at, user_id) VALUES
...
(2,12.99,'Margherita Pizza',(SELECT id FROM orders WHERE user_id=(SELECT id FROM user WHERE email='alice@example.com') ORDER BY id DESC LIMIT 1),(SELECT id FROM product WHERE name='Margherita Pizza' LIMIT 1));
